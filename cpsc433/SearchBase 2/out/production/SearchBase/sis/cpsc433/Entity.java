...
public class Entity implements Comparable<Entity>{
	 ...
	 * @param e another cpsc433.Entity.
	 */
	...
	/**
	 * If the parameter object is an <code>cpsc433.Entity</code>,
	 * compares the name of this object with that of the parameter:
	 * <code>name.compareTo(((cpsc433.Entity)arg0).name)</code>.  Otherwise
	 * throws a <code>java.lang.ClassCastException</code> exception.
	 * @param arg0 another object ot compare to (hopefully, another <em>cpsc433.Entity</em>.
	 ...
	 * If the parameter object is an <code>cpsc433.Entity</code>,
	 * compares the name of this object with that of the parameter:
	 * <code>name.equals(((cpsc433.Entity)arg0).name)</code>.  Otherwise
	 * returns false.
	 * @param arg0 another object ot compare to (hopefully, another <em>cpsc433.Entity</em>.
	 * @return true if the argument is an <em>cpsc433.Entity</em> and the names are equal, false otherwise.
	 */
	@Override
