...
/**
 * Implements a simple key/value pair which supports the {@link Comparable}
 * contract and the {@link Map.Entry} contract.
 *
...
public class Pair<K, V> implements Map.Entry<K,V>, Comparable<Object> {
     ...
     * Pair object, then throw {@link ClassCastException}
     ...
     * {@link String#compareTo(String)} with tthe other object's
